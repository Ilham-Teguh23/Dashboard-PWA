...
export default () => {
    ...
    useEffect(() => {
        const fetchOrderVoucher = async () => {
            try {
                // Fetch data dari API order-voucher
                ...
                if (data.success === true) {
                    ...
                    // Mendapatkan transaksi terbaru berdasarkan user_id
                    ...
                    console.log("VOUCHER");
                    console.log(latestTransactionArray);

                    // Fetch data member/list
                    ...
                    const filteredMembers = latestTransactionArray
                        .map((transaction) => {
                            const memberName = userMap[transaction.user_id]; // Ambil nama member berdasarkan user_id
                            if (memberName) {
                                return { ...transaction, mmbr_name: memberName }; // Gabungkan nama member langsung ke transaksi
                            }
                    ...
                    setAllMemberData(filteredMembers);
