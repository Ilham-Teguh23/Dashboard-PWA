...
import PaymentIn from "./payment/In.js";
...
import TABUserGrafik from "./tab/user/grafik.js"
import TABIndex from "./tab/index.js"
import TABTransaksi from "./tab/transaksi.js"
import TABPesanMassal from "./tab/PesanMassal.js"
...
import TABB2BPesanMassal from "./tabB2b/PesanMassal.js"
...
export default () => {
    ...
    const [getSubMenuData] = useState([
        ...
        {
            id: 69,
            component: TABPesanMassal,
            path: Routes.TABPesanMassal.path
        },
        {
            id: 69,
        ...
        {
            id: 69,
            component: TABB2BPesanMassal,
            path: Routes.TABB2BPesanMassal.path
        },
        {
            id: 69,
        ...
        {
            id: 69,
            component: TABUserGrafik,
            path: Routes.TABUserGrafik.path
        },
        {
            id: 69,
