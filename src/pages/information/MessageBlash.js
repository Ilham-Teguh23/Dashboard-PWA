...
function MessageBlash() {
    ...
    const getDataMitra = async () => {
        try {
            if (selectData !== "1") {
                ...
                await axios
                    .post(`${process.env.REACT_APP_PORTAL_API_URL}/mitra/list`, data)
                    .then((res) => {
    ...
    const generatePushNotif = () => {
        try {
            if (pilihJenisNotif === "1") {
                ...
                axios
                    .post(
                        `${process.env.REACT_APP_PORTAL_API_URL}/global/information/add`,
                        data
                    )
                    .then((res) => {
    ...
    const getInformationPushNotif = async () => {
        try {
            ...
            await axios
                .post(
                    `${process.env.REACT_APP_PORTAL_API_URL}/global/information`,
                    data
                )
                .then((res) => {
    ...
    return (
        <Fragment>
                        ...
                        <div className=" border-light d-flex justify-content-between card-header">
                            ...
                            <div className="btn-group">
                                <button
                                    ...
                                    className={`btn btn-outline-success btn-sm ${pilihJenisNotif === "1" ? "active" : ""
                                        }`}
                                >
                                    Notif
                                </button>
                                <button
                                    ...
                                    type="button"
                                    className={`btn btn-outline-danger btn-sm ${pilihJenisNotif === "2" ? "active" : ""
                                        }`}
                                >
                                    Email
                                </button>
            ...
            <div className="shadow-sm card border-light">
                <div className=" border-light d-flex justify-content-between card-header"></div>
