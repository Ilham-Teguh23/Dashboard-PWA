...
export default () => {
    ...
    const [getMessageEmptyData, setMessageEmptyData] = useState(
        "Belum ada pembayaran pada hari ini"
    );

    const [getPembayaranById, setPembayaranById] = useState([])
    ...
    const handleModalById = async (id) => {
        try {

            const response = await fetch(
                `${process.env.REACT_APP_API_PWA_TNOSWORLD_URL}/no-referensi/${id}`
            )
                ...
                <td className="text-center">
                    {no_referensi === null ? (
                        ...
                        >
                            ...
                            <Modal show={showModalBayar} onHide={handleCloseBayar} centered size="md">
                                <Modal.Body>
                                    <Form onSubmit={onDoneSubmit} method="POST">
                                        <Form.Group className="mb-3">
                                            <Form.Label>
                                            ...
                                            <Form.Control
                                                type="text"
                                                value={getPembayaranById?.bank_paid_vendor}
                                            />
                                        </Form.Group>
                                        <Form.Group className="mb-3">
                                            <Form.Label>
                                            ...
                                            <Form.Control
                                                type="text"
                                                value={getPembayaranById?.no_referensi}
                                                disabled
                                            />
                                        </Form.Group>
                                        <Form.Group className="mb-3">
                                            ...
                                            <Form.Control
                                                type="datetime"
                                                value={getPembayaranById?.date_paid_vendor}
                                            />
                                        </Form.Group>
                                        <Form.Group className="mb-3">
                                            <Form.Label>Catatan</Form.Label>
                                            <Form.Control
                                                as="textarea"
                                                rows="6"
                                                value={getPembayaranById?.note_paid_vendor}
                                                disabled
                                            />
                                        </Form.Group>
                                        <Row>
    ...
    const onDoneSubmit = async (e) => {

        e.preventDefault();
        const formData = new FormData(e.target);

        fetch(
            `${process.env.REACT_APP_API_PWA_TNOSWORLD_URL}/update-pembayaran`,
            {
                method: "PUT",
                headers: {
                ...
                body: JSON.stringify({
                    id: pembayaranId.toString(),
                    no_referensi: formData.get("no_referensi"),
                    date_paid_vendor: formData.get("date_paid_vendor"),
                    note_paid_vendor: formData.get("note_paid_vendor"),
                    bank_paid_vendor: formData.get("bank_paid_vendor"),
                }),
            }
        )
            .then((res) => res.json())
                                ...
                                <>
                                    ...
                                    >
                                        <tr>
                                            ...
                                            <th className="border-0">No. Referensi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
