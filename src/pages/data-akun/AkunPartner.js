        ...
        if (!searchTerm) {
            ...
            filteredData = originalData.filter(item => {
                return (
                    ...
                    (item.unique_institution_id && item.unique_institution_id.toLowerCase().includes(searchTerm))
                );
            });
        }
        ...
        return (
            <tr>
                ...
                <td className="text-center">
                    <Link to={`/data-akun/partner/${institution_id}`}>
                ...
                <td className="text-center">
                    {unique_institution_id ? unique_institution_id : "-"}
                </td>
            ...
            .then((data) => {
                ...
                if (Array.isArray(accounts)) {
                    let filteredData = accounts.filter(
                        (item) => item.account_category === "PARTNER"
                    );
                                ...
                                <>
                                    <thead className="thead-light" style={{ position: "sticky", top: 0, zIndex: 1 }}>
                                        <tr>
                                            ...
                                            <th className="border-0 text-center">Kode Institusi</th>
